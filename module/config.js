...
exaltedthird.activeEffectChanges = {
    ...
    "system.settings.rollsettings.attacks.bonus": "Ex3.Attacks(PC)",
    "system.settings.rollsettings.attackrollsettings.withering.bonus": "Ex3.WitheringAttacks(PC)",
    "system.settings.rollsettings.attackrollsettings.decisive.bonus": "Ex3.DecisiveAttacks(PC)",
    "system.settings.rollsettings.attackrollsettings.gambit.bonus": "Ex3.Gambits(PC)",
    "system.settings.rollsettings.command.bonus": "Ex3.Command(PC)",
    "system.settings.rollsettings.craft.bonus": "Ex3.Craft(PC)",
    "system.settings.rollsettings.disengage.bonus": "Ex3.Disengage(PC)",
    "system.settings.rollsettings.grapplecontrol.bonus": "Ex3.GrappleControl(PC)",
    "system.settings.rollsettings.joinbattle.bonus": "Ex3.JoinBattle(PC)",
    "system.settings.rollsettings.readintentions.bonus": "Ex3.ReadIntentions(PC)",
    "system.settings.rollsettings.rush.bonus": "Ex3.Rush(PC)",
    "system.settings.rollsettings.social.bonus": "Ex3.Social(PC)",
    "system.settings.rollsettings.sorcery.bonus": "Ex3.Sorcery(PC)",

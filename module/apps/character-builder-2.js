...
export default class CharacterBuilder2 extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  static DEFAULT_OPTIONS = {
    ...
    tag: "form",
    form: {
      handler: CharacterBuilder2.myFormHandler,
      submitOnClose: false,
      submitOnChange: true,
      closeOnSubmit: false
    },
    ...
    actions: {
      showHelpDialog: CharacterBuilder2.showHelpDialog,
      saveCharacter: CharacterBuilder2.saveCharacter,
      randomAttributes: CharacterBuilder2.randomAttributes,
      randomAbilities: CharacterBuilder2.randomAbilities,
      addItem: CharacterBuilder2.addItem,
      randomName: CharacterBuilder2.randomName,
      randomItem: CharacterBuilder2.randomItem, 
      importItem: CharacterBuilder2.importItem,
      deleteItem: CharacterBuilder2.deleteItem,
      deleteSublistCharm: CharacterBuilder2.deleteSublistCharm,
      lowerCharmCount: CharacterBuilder2.lowerCharmCount,
      addCharmCount: CharacterBuilder2.addCharmCount,
    },

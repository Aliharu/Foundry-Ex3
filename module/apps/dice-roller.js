...
export default class RollForm extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    async _createChatMessageContent(content, cardName = 'Roll', rollArray = [], flags = null) {
        ...
        const chatMessage = ChatMessage.applyMode(
            { user: game.user.id, speaker: this.actor !== null ? ChatMessage.getSpeaker({ actor: this.actor }) : {}, content: messageContent, style: CONST.CHAT_MESSAGE_STYLES.OTHER, rolls: rollArray, flags: flags },

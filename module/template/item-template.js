import { activatableData, artifactData, equipmentData, traitField } from "./common-template";
...
export class ItemCharmData extends CommonItemData {
    static defineSchema() {
        ...
        return {
            ...
            charmprerequisites: new fields.ArrayField({ initial: [] }),
            ...
            diceroller: new fields.SchemaField({
                ...
                reducedifficulty: new fields.NumberField({ initial: 0 }),
                ...
                triggertenscap: new fields.NumberField({ initial: 0 }),
                ...
                rerollcap: new fields.SchemaField({
                    ...
                    three: new fields.NumberField({ initial: 0 }),
                    four: new fields.NumberField({ initial: 0 }),
                    five: new fields.NumberField({ initial: 0 }),
                    six: new fields.NumberField({ initial: 0 }),
                    seven: new fields.NumberField({ initial: 0 }),
                    eight: new fields.NumberField({ initial: 0 }),
                    nine: new fields.NumberField({ initial: 0 }),
                    ten: new fields.NumberField({ initial: 0 }),
                }),
                doublesucccesscaps: new fields.SchemaField({
                    sevens: new fields.NumberField({ initial: 0 }),
                    eights: new fields.NumberField({ initial: 0 }),
                    nines: new fields.NumberField({ initial: 0 }),
                    tens: new fields.NumberField({ initial: 0 }),
                }),
                ...
                damage: new fields.SchemaField({
                    ...
                    postsoakdamage: new fields.NumberField({ initial: 0 }),
                    ignoresoak: new fields.NumberField({ initial: 0 }),
                    ignorehardness: new fields.NumberField({ initial: 0 }),

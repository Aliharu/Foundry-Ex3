    ...
    static defineSchema() {
        ...
        return {
            ...
            diceroller: new fields.SchemaField({
                ...
                bonusdice: new fields.StringField({ initial: "" }),
                bonussuccesses: new fields.StringField({ initial: "" }),
                doublesuccess: new fields.NumberField({ initial: 11 }),
                decreasetargetnumber: new fields.NumberField({ initial: 0 }),
                rerolldice: new fields.StringField({ initial: "" }),
                diceToSuccesses: new fields.NumberField({ initial: 0 }),
                reducedifficulty: new fields.StringField({ initial: "" }),
                ...
                triggertenscap: new fields.StringField({ initial: "" }),
                ...
                rerollcap: new fields.SchemaField({
                    ...
                    nine: new fields.StringField({ initial: "" }),
                    ten: new fields.StringField({ initial: "" }),
                }),
                doublesucccesscaps: new fields.SchemaField({
                    sevens: new fields.StringField({ initial: "" }),
                    eights: new fields.StringField({ initial: "" }),
                    nines: new fields.StringField({ initial: "" }),
                    tens: new fields.StringField({ initial: "" }),
                }),
                ...
                damage: new fields.SchemaField({
                    ...
                    decreasetargetnumber: new fields.NumberField({ initial: 0 }),
                    rerolldice: new fields.StringField({ initial: "" }),
                    dicetosuccesses: new fields.StringField({ initial: "" }),
                    rerollfailed: new fields.BooleanField({ initial: false }),
                    rolltwice: new fields.BooleanField({ initial: false }),
                    overwhelming: new fields.StringField({ initial: "" }),
                    postsoakdamage: new fields.StringField({ initial: "" }),
                    ignoresoak: new fields.StringField({ initial: "" }),
                    ignorehardness: new fields.StringField({ initial: "" }),
                ...
                opposedbonuses: new fields.SchemaField({
                    ...
                    dicemodifier: new fields.StringField({ initial: "" }),
                    successmodifier: new fields.StringField({ initial: "" }),
                    rerollsuccesses: new fields.StringField({ initial: "" }),
                    defense: new fields.StringField({ initial: "" }),
                    soak: new fields.StringField({ initial: "" }),
                    shieldinitiative: new fields.StringField({ initial: "" }),
                    hardness: new fields.StringField({ initial: "" }),
                    increasedamagetargetnumber: new fields.NumberField({ initial: 0 }),
                    increasetargetnumber: new fields.NumberField({ initial: 0 }),
                    increasegambitdifficulty: new fields.StringField({ initial: "" }),
                    damagemodifier: new fields.StringField({ initial: "" }),
                    resolve: new fields.StringField({ initial: "" }),
                    guile: new fields.StringField({ initial: "" }),
